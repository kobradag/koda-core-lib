 ...
 *
 * @param {string} prefix Network prefix. E.g.: 'kobratest'.
 */
...
const kobraNetworks = ['kobra', 'kobradev', 'kobrareg', 'kobratest', 'kobrasim'];

kobraNetworks.map((str) => {
  addNetwork({
    name: str,
    prefix: str,
    pubkeyhash: 0x00, // publickey hash prefix
    privatekey: 0x80, // privatekey prefix -- must be 128 or toWIF() result will not match with kobra
    scripthash: 0x05,
