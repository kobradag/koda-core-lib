...
var HDPrivateKey = kobracore.HDPrivateKey;
var HDPublicKey = kobracore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = kobracore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(kobracore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(kobracore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      kobracore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = kobracore.PublicKey.fromPoint;
      kobracore.PublicKey.fromPoint = function() {
        kobracore.PublicKey.fromPoint = unstubbed;
