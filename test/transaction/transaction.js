...
var BN = kobracore.crypto.BN;
var Transaction = kobracore.Transaction;
var Signature = kobracore.Signature;
var Input = kobracore.Transaction.Input;
var Output = kobracore.Transaction.Output;
...
var Opcode = kobracore.Opcode;
var errors = kobracore.errors;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    ...
    tx.inputs[0].should.be.instanceof(kobracore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(kobracore.Script);
