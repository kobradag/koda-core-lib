...
Kobracore and most official submodules work in the browser, thanks to [browserify](http://browserify.org/) (some modules are not fully compatible with web browsers).
...
<body>
  ...
  <script type="text/javascript">
    var kobracore = require('bitcore-lib');
