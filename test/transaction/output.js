...
var BufferWriter = kobracore.encoding.BufferWriter;
var BufferReader = kobracore.encoding.BufferReader;
...
describe("Output", function() {
  ...
  it("#toObject roundtrip will handle an invalid (null) script", function() {
    ...
    var br = new kobracore.encoding.BufferReader(invalidOutputScript);
